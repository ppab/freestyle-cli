...
export const routesGenericFactory = {
  build: ({
    ...
    routesFactory
      .entityPlural(KEBAB_CASE_ENTITY_PLURAL, PASCAL_CASE_ENTITY_PLURAL)
      .build(),
    routesFactory
      .entity(`${KEBAB_CASE_ENTITY_PLURAL}/:id`, PASCAL_CASE_ENTITY)
      .build(),
    routesFactory
      .createEntity(`${KEBAB_CASE_ENTITY_PLURAL}/create`, PASCAL_CASE_ENTITY)
      .build(),
  ],
};
