...
const schema = {
    ...
    stateKey: '{{KEBAB_CASE_ENTITY_PLURAL}}',
    arguments:[],
    appNavigation: [
        {
            role: 'fullRole',
    ...
    colDef: {
        list: [
            {
                headerName: 'Id',
                ...colDefItemComponentsFactory('LinkButton', {routeName: 'Contacts'})
            },
        ...
        componentsLayout: {
            section1: {
                ...
                children: ['itemComponents.topBar'],
            },
            section2: {
                component: 'MyLayoutComponent2',
                children: ['itemComponents.middleBar'],
            }
        }
    },
    form: {
